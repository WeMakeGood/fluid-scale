	...
	<div class="fs-layout">
		...
		<div class="fs-layout-form">
			<form method="post" action="<?php echo esc_url( admin_url( 'admin-post.php' ) ); ?>" id="fluid-scale-form">
				...
				<p class="description"><?php esc_html_e( 'Shared by type and space scales.', 'fluid-scale' ); ?></p>
				...
				<table class="form-table" role="presentation">
					...
					<tr>
						...
						<td>
							...
							<span class="description"><?php esc_html_e( 'step-0 at min viewport', 'fluid-scale' ); ?></span>
						</td>
					</tr>
					<tr>
						...
						<td>
							...
							<span class="description"><?php esc_html_e( 'step-0 at max viewport', 'fluid-scale' ); ?></span>
						</td>
					</tr>
					<tr>
					...
					<tr>
						...
						<td>
							...
							<span class="description"><?php esc_html_e( 'step--1 through step--N', 'fluid-scale' ); ?></span>
						</td>
					</tr>
					<tr>
				...
				<table class="form-table" role="presentation">
					<tr>
						...
						<td>
							...
							<span class="description"><code>--grid-max-width</code></span>
						</td>
					</tr>
					<tr>
				...
				<p class="description">
					<?php esc_html_e( 'Generate additional --space-{from}-{to} variables for specific layout needs.', 'fluid-scale' ); ?>
				</p>
				...
				<!-- Generated CSS (inside form column, below save button) -->
